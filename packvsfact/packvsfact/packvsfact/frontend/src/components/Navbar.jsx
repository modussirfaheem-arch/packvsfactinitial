...
import { ShieldCheck, Camera, Scale, Sparkles, User as UserIcon, LayoutDashboard, Settings, Wifi, ShoppingBag, Smartphone, Home } from 'lucide-react';
...
export default function Navbar({ user, onOpenAuth, basketCount = 0, onOpenBasket }) {
  ...
  const navLinks = [
    ...
    { path: '/assistant', label: '18-Lang Voice AI', icon: Sparkles },
  ];
