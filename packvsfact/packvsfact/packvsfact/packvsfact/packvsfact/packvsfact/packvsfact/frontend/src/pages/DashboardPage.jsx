      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white rounded-2xl border border-stone-200">
            ...
            <p className="text-stone-700 font-semibold text-sm">No products found matching query.</p>
            <p className="text-stone-500 text-xs mt-1">Try clearing filters or searching for another Indian food item.</p>
          </div>
        ) : (
